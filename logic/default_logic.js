...
module.exports = function container (get, set, clear) {
  ...
  return [
    ...
    function (tick, trigger, rs, cb) {
      ...
      rs.min_double_wait = 43200000 * 1 // wait in ms after action before doing same action
      rs.min_reversal_wait = 43200000 * 0.75 // wait in ms after action before doing opposite action
